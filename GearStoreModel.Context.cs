...
namespace Gear_Store
{
    ...
    public partial class GearStoreEntities : DbContext
    {
        ...
        public virtual int InsertStaff(string pass, string users_name, Nullable<System.DateTime> birthday, string addr, Nullable<decimal> salary, string email, string phone, Nullable<int> poisition)
        {
            ...
            var poisitionParameter = poisition.HasValue ?
                new ObjectParameter("poisition", poisition) :
                new ObjectParameter("poisition", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertStaff", passParameter, users_nameParameter, birthdayParameter, addrParameter, salaryParameter, emailParameter, phoneParameter, poisitionParameter);
        }
        ...
        public virtual int UpdateStaff(string id, string pass, string users_name, Nullable<System.DateTime> birthday, string addr, Nullable<decimal> salary, string email, string phone, Nullable<int> poisition)
        {
            var idParameter = id != null ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateStaff", idParameter, passParameter, users_nameParameter, birthdayParameter, addrParameter, salaryParameter, emailParameter, phoneParameter, poisitionParameter);
        }
    }
}
